...
public class BringToBackgroundCommandTest {
    ...
    void constructorShouldStoreModelAndShape() {
        BringToBackgroundCommand command = new BringToBackgroundCommand(drawingModel, shapeTest);
    ...
    void executeShouldNotChangeZOfTheSingleShape() {
        ...
        // Verifica che la forma sia stata portata in background
        assertNotNull(drawingModel.getShapes());
        assertNotNull(shapeTest);
        assertEquals(oldZ, shapeTest.getZ(), "Lo Z della forma non dovrebbe essere cambiato");
    }
    ...
    void executeShouldChangeZOfTwoShapes() {
        ...
        BringToBackgroundCommand command = new BringToBackgroundCommand(drawingModel, ellTest);
        command.execute();
